...
class ExportContactList
  def self.run
    ...
    puts "Exported contacts to #{csv_filename}"
  end

  def self.load_all_company_contacts
    contacts_file_paths = Dir.glob(File.join("#{PitchSlapped::Utils.root_dir}/results/orchestrator_20251117_140603/company_contacts", "**", "*.json"))
